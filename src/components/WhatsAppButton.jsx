...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="whatsapp-float fixed bottom-5 right-5 z-40 w-14 h-14 sm:w-[60px] sm:h-[60px] rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300"
